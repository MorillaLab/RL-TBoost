...
<p align="center">
  ...
  <br/>
  <em>RL-TBoost training performance using synthetic data of similar distribution. Panel A — The RL training loop with train/test loss curves and the topological shape-preservation decision markers: green circles = shape preserved (agent continues), red crosses = shape violated (agent stops). This is the core novel idea made visual.
